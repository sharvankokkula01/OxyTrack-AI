...
import { Mail, Lock, Eye, EyeOff, AlertCircle, CircleDot } from 'lucide-react';
        ...
        >
          <motion.div className="mb-8 text-center" variants={itemVariants}>
            ...
            <p className={cn('mt-2 text-sm', isDark ? 'text-slate-400' : 'text-slate-600')}>
              Hospital Oxygen Cylinder Management System
            </p>
          </motion.div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <motion.div variants={itemVariants} className="flex items-center gap-2">
              <input
                ...
                disabled={loading}
              />
              <label htmlFor="remember" className={cn('text-sm cursor-pointer', isDark ? 'text-slate-300' : 'text-slate-700')}>
                Remember me
              </label>
            </motion.div>
            ...
            <motion.div variants={itemVariants} className="pt-4 text-center space-y-2">
              <Link
                to="/forgot-password"
                className={cn(
